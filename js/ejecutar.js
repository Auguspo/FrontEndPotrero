function inclusive() {
  ...
  document.getElementById("cd3").style.backgroundColor = "grey"
  document.getElementById("cd4").style.backgroundColor = "grey"
 
 
}

function copy() {
  alert("Autor: Augusto Poletti. EMAIL: augustpolet@gmail.com")
}
